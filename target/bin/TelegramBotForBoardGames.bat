...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="TelegramBotForBoardGames" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.savushkinvyacheslav.BotInitializer %CMD_LINE_ARGS%
