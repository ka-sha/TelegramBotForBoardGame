...
public class DiceSetTest {
    ...
    public void toStringVariousSeveralDicesTest() {
        assertEquals("d4+d6", new DiceSet(new String[]{"d4", "d6"}).toString());
        assertEquals("d4+d6+d8", new DiceSet(new String[]{"d4", "d6", "d8"}).toString());
        assertEquals("d4+d6+d8+d10", new DiceSet(new String[]{"d4", "d6", "d8", "d10"}).toString());
        assertEquals("d4+d6+d8+d10+d12", new DiceSet(new String[]{"d4", "d6", "d8", "d10", "d12"}).toString());

        assertEquals("4d4+d6+d8+d10+d12", new DiceSet(new String[]{"4d4", "d6", "d8", "d10", "d12"}).toString());
        assertEquals("d4+4d6+d8+d10+d12", new DiceSet(new String[]{"d4", "4d6", "d8", "d10", "d12"}).toString());
        assertEquals("d4+d6+4d8+d10+d12", new DiceSet(new String[]{"d4", "d6", "4d8", "d10", "d12"}).toString());
        assertEquals("d4+d6+d8+4d10+d12", new DiceSet(new String[]{"d4", "d6", "d8", "4d10", "d12"}).toString());
        assertEquals("d4+d6+d8+d10+4d12", new DiceSet(new String[]{"d4", "d6", "d8", "d10", "4d12"}).toString());

        assertEquals("6d4+6d6+d8+d10+d12", new DiceSet(new String[]{"6d4", "6d6", "d8", "d10", "d12"}).toString());
        assertEquals("6d4+d6+6d8+d10+d12", new DiceSet(new String[]{"6d4", "d6", "6d8", "d10", "d12"}).toString());
        assertEquals("6d4+d6+d8+6d10+d12", new DiceSet(new String[]{"6d4", "d6", "d8", "6d10", "d12"}).toString());
        assertEquals("6d4+d6+d8+d10+6d12", new DiceSet(new String[]{"6d4", "d6", "d8", "d10", "6d12"}).toString());
        assertEquals("d4+3d6+3d8+d10+d12", new DiceSet(new String[]{"d4", "3d6", "3d8", "d10", "d12"}).toString());
        assertEquals("d4+3d6+d8+3d10+d12", new DiceSet(new String[]{"d4", "3d6", "d8", "3d10", "d12"}).toString());
        assertEquals("d4+3d6+d8+d10+3d12", new DiceSet(new String[]{"d4", "3d6", "d8", "d10", "3d12"}).toString());
        assertEquals("d4+d6+5d8+5d10+d12", new DiceSet(new String[]{"d4", "d6", "5d8", "5d10", "d12"}).toString());
